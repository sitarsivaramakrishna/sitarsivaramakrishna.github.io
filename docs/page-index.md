...
| 2 | `#explore` | Explore | 3 cards linking to sub-pages: The Sitarist (Shalle Bangalore concert photo bg), Aruna Music (aruna-logo), SRK Academy (srk-academy-logo-new.svg). |
...
- Explore card backgrounds: `assets/images/gallery/concert-shalle-bangalore.webp`, `assets/images/aruna-logo.png`, `assets/images/srk-academy-logo-new.svg`
